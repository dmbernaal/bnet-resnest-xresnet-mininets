...
import math
from ..activations import Swish, Mila, Mish, BentID, get_activation_
from ..bnet import BNET2d
...
class ResBlock(nn.Module):
    ...
    def __init__(self, expansion, ni, nf, stride=1, groups=1, reduction=None, nh1=None, nh2=None, dw=False, g2=1, sa=False, sym=False, norm='bn', act_cls='relu', ks=3, pool_first=True, **kwargs):
        ...
        self.act = get_activation_('relu', inplace=True) if act_cls=='relu' else get_activation_(act_cls)
